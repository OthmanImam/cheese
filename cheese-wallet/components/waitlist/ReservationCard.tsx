export default function ReservationCard() {
  return (
    <div style={{
      ...
      {/* Three micro-points */}
      {[
        { icon: "shield-check", label: "Exclusive 3-month lock" },
        { icon: "finger-print", label: "Identity tied to your account" },
        ...
        <div key={point.label} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
          ...
          <span style={{ fontSize: 13, color: "rgba(245,238,216,0.6)", fontWeight: 400 }}>
            {point.label}
          </span>
        </div>
      ))}
